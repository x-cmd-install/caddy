...
![caddy](https://repo.x-cmd.io/caddy.svg?lang=zh)
...
合计: **81,040** 行代码（覆盖前 5 种语言、共 **359** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 76,197 | 19,995 | 11,122 | 349 |
| Css | 2,827 | 9 | 0 | 1 |
| Html | 1,995 | 38 | 47 | 4 |
| Bitbake | 14 | 5 | 3 | 2 |
| Php | 3 | 0 | 0 | 3 |
...
- **Star**: 75,658 · **Fork**: 4,952 · **开放 issue**: 4,617 · **贡献者**: 444

## 累计统计

- **发布数**: 136 · **已合并 PR**: 2420 · **开放 PR**: 77 · **已关闭 issue**: 4418 · **开放 issue**: 199 · **提交数**: 2681

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 0 | 25 | 20 | 10 | 7 | 30 |
| last60d | 2026-07-13 | 0 | 54 | 27 | 22 | 10 | 57 |
| 90d | 2026-06-13 | 0 | 70 | 35 | 35 | 15 | 78 |
| last180d | 2026-03-15 | 2 | 148 | 47 | 93 | 24 | 173 |
| 360d | 2025-09-16 | 6 | 267 | 62 | 211 | 45 | 329 |
| last720d | 2024-09-21 | 17 | 459 | 73 | 532 | 120 | 591 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/caddy.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T20:37:35Z._
